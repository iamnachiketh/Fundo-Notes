...
const NoteController = __importStar(require("../controller/note.controller"));
const AuthMiddleware = __importStar(require("../middleware/auth.middleware"));
const express_validator_1 = require("express-validator");
const router = express_1.default.Router();
router.post("/", (0, express_validator_1.body)('noteId').notEmpty().isString(), (0, express_validator_1.body)('userEmail').notEmpty().isString(), (0, express_validator_1.body)('title').notEmpty().isString(), (0, express_validator_1.body)('desc').notEmpty().isString(), AuthMiddleware.verifyToken, NoteController.handleCreateNote);
