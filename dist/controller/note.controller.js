...
exports.handleGetAllNotesOfAUser = exports.handleGetNoteById = exports.handleCreateNote = void 0;
...
const handleGetNoteById = function (req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            if (data.userEmail !== payload.email || !(yield NoteService.checkNoteId(noteId, data.userEmail))) {
